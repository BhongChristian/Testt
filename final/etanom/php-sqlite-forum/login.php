...
<head>
    ...
    <title>LOGIN | Simple Forum Site</title>
...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">ETANOMM</h3>
            ...
            <div class="card-body">
                ...
                <form action="" id="login-form">
                    ...
                    <div class="mb-3 d-flex w-100 justify-content-between  align-items-end">
                        <a href="registration.php" class="btn btn-sm btn-primary rounded-0 my-1" style="background-color: rgb(83, 178, 138);">Sign Up</a>
                        <button class="btn btn-sm btn-primary rounded-0 my-1" style="background-color: rgb(83, 178, 138);">Login</button>
                    </div>
                </form>
                <!-- Login Form Wrapper -->
            </div>

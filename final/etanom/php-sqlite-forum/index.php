...
<head>
    ...
    <title><?= ucwords($title) ?>Farmes's Community</title>
...
<body>
    <main>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgb(21, 122, 80); fixed-top mb-5" id="topNavBar">
        <div class="container">
            <a class="navbar-brand" href="http://localhost/final/etanom/">
            Etanom
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <?php if(isset($_SESSION['type']) && $_SESSION['type'] == 1):?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'home')? 'active' : '' ?>" aria-current="page" href="http://localhost/final/etanom/admin/">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="http://localhost/final/etanom/admin/?page=crops">Crops</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="http://localhost/final/etanom/admin/?page=crops">Users</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="./?page=users">Com Users</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'home')? 'active' : '' ?>" aria-current="page" href="./">Manage</a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>

...
<head>
    ...
    <title>Registration | mysqli Login and Registration</title>
            ...
            <div class="card-body">
                ...
                <form action="" id="register-form">
                    ...
                    <div class="mb-3 d-flex w-100 justify-content-between align-items-end">
                         <a href="login.php" class="btn btn-sm btn-primary rounded-0 my-1" style="background-color: rgb(83, 178, 138);">Login</a>
                         <button class="btn btn-sm btn-primary rounded-0 my-1" style="background-color: rgb(83, 178, 138);">Register</button>
                    </div>
                </form>
                <!-- Registration Form Wrapper -->
            </div>

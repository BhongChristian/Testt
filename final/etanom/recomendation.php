...
<nav>
  ...
  <a href="http://localhost/final/etanom/php-sqlite-forum/">Forum</a>
</nav>
...
<div id="recommendation-container">
  ...
  <select id="crop">
    ...
    <option value="chayote">Chayote(Sayote)</option>
    ...
    <option value="nalta jute">Nalta Jute (Saluyot)</option>
